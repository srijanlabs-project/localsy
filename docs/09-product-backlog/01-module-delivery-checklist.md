...
| Geography Master | geo-boundary | P0 | Present | In Progress | Done | Done | Done | In Progress | [src/components/GeographyConfigManager.tsx](/D:/localsy/src/components/GeographyConfigManager.tsx) | Boundary coverage is now visible in admin and still derives from `/api/admin/geography/boundaries` |
...
| SEO Analytics | impressions | P1 | Present | In Progress | Done | Done | Done | In Progress | [src/components/admin/ListingAnalyticsPanel.tsx](/D:/localsy/src/components/admin/ListingAnalyticsPanel.tsx) | Admin SEO snapshot now visualizes aggregate impression metrics |
| SEO Analytics | clicks | P1 | Present | In Progress | Done | Done | Done | In Progress | [src/components/admin/ListingAnalyticsPanel.tsx](/D:/localsy/src/components/admin/ListingAnalyticsPanel.tsx) | Admin SEO snapshot now visualizes aggregate click metrics |
| SEO Analytics | landing pages | P1 | Present | In Progress | Done | Done | Done | In Progress | [src/components/admin/ListingAnalyticsPanel.tsx](/D:/localsy/src/components/admin/ListingAnalyticsPanel.tsx) | Landing-page performance is now surfaced inside admin SEO analytics |
| SEO Analytics | route coverage | P1 | Present | In Progress | Done | Done | Done | In Progress | [src/components/admin/ListingAnalyticsPanel.tsx](/D:/localsy/src/components/admin/ListingAnalyticsPanel.tsx) | Route coverage counts are now visible in admin SEO analytics |
| SEO Analytics | indexed pages | P1 | Present | In Progress | Done | Done | Done | In Progress | [src/components/admin/ListingAnalyticsPanel.tsx](/D:/localsy/src/components/admin/ListingAnalyticsPanel.tsx) | Indexed listing estimates are now surfaced in the admin SEO snapshot |
...
| Listing Operations | suspend | P0 | Present | In Progress | Done | Done | Done | In Progress | [src/components/admin/ListingStatusWorkspace.tsx](/D:/localsy/src/components/admin/ListingStatusWorkspace.tsx) | Admin listing status workspace now supports suspend actions with reason and timestamp handling |
| Listing Operations | bulk update | P0 | Present | In Progress | Done | Done | Done | In Progress | [src/components/admin/ListingStatusWorkspace.tsx](/D:/localsy/src/components/admin/ListingStatusWorkspace.tsx) | Bulk approve, suspend, and reject are now available from the listing status workspace |
...
| Listing Analytics | views | P1 | Present | In Progress | Done | Done | Done | In Progress | [src/components/admin/ListingAnalyticsPanel.tsx](/D:/localsy/src/components/admin/ListingAnalyticsPanel.tsx) | Admin snapshot now aggregates listing views from auditable interaction events |
| Listing Analytics | clicks | P1 | Present | In Progress | Done | Done | Done | In Progress | [src/components/admin/ListingAnalyticsPanel.tsx](/D:/localsy/src/components/admin/ListingAnalyticsPanel.tsx) | Admin snapshot now aggregates click signals including WhatsApp intent and contact actions |
| Listing Analytics | unlocks | P1 | Present | In Progress | Done | Done | Done | In Progress | [src/components/admin/ListingAnalyticsPanel.tsx](/D:/localsy/src/components/admin/ListingAnalyticsPanel.tsx) | Contact unlock counts are now surfaced in listing analytics |
| Listing Analytics | reviews | P1 | Present | In Progress | Done | Done | Done | In Progress | [src/components/admin/ListingAnalyticsPanel.tsx](/D:/localsy/src/components/admin/ListingAnalyticsPanel.tsx) | Review volume is now folded into the listing analytics snapshot |
| Listing Analytics | leads | P1 | Present | In Progress | Done | Done | Done | In Progress | [src/components/admin/ListingAnalyticsPanel.tsx](/D:/localsy/src/components/admin/ListingAnalyticsPanel.tsx) | Seller-side lead records are now rolled into the listing analytics snapshot |
