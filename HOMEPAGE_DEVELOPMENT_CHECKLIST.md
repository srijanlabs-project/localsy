...
| QA | Consolidated pre-UAT verification command now exists | Done | `npm run qa:uat` runs the current access, public-write, workflow, resolved-homepage, runtime, lint, server syntax, and build gates in one repeatable pass. |
